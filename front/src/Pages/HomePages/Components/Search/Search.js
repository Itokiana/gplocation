				...
				<div className="container">
					...
					<div>{ this.state.message!=='' ?
							(
								...
								<div className="alert_message"><a href='https://www.rentiles.fr/?listing=1&fond=contenu&id_contenu=465&date_d=11/02/2021&heure_d=10:00&date_f=21/02/2021&heure_f=10:00&affiliate=1476&nocache=1612962739'> lien </a></div>:
